...
export class FooterComponent implements OnInit {
  ...
  setFooterData() {
    this.footerData = {
      companyName: 'Chitra',
      description: 'Hello, I am Chitra; The 22-year-old is a frontend developer. I started programming in 2021. These days, along with programming, I study about startups and businesses, and besides all this.',
      products: [
        { name: 'Angular', link: '#!' },
        { name: 'Php', link: '#!' },
